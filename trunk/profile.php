...
<div id="wrapper">
	<div class="header">
      ...
      <!-- InstanceEndEditable -->
        <div id="menu"></div>
       <div id="mapMenu"><!-- InstanceBeginEditable name="siteMap" --><table cellpadding="0" cellspacing="0"><tr><td><a href="index.php">Почетна</a>&nbsp;&nbsp;&nbsp;&raquo;&nbsp;</td><td>Профил&nbsp;</td></tr></table><!-- InstanceEndEditable --></div> 
      </div>
	</div>
    ...
    <div class="mainBody">
   	  <div class="content">
            ...
            <div class="middle-red-block">
                <div class="title">
                    <div class="left"></div>
                    <div class="middle"><div class="text"><!-- InstanceBeginEditable name="BlockTitle" -->Кориснички профил<!-- InstanceEndEditable --></div></div>
                    <div class="right"></div>
                </div>
