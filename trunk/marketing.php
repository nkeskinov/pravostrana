...
<div id="wrapper">
	<div class="header">
      ...
      <!-- InstanceEndEditable -->
       <div id="mapMenu"><!-- InstanceBeginEditable name="siteMap" --><table cellpadding="0" cellspacing="0"><tr><td><a href="index.php">Почетна</a>&nbsp;&nbsp;&nbsp;&raquo;&nbsp;</td><td>Маркетинг</td></tr></table><!-- InstanceEndEditable --></div> 
      </div>
	</div>
