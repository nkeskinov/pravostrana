...
<div id="wrapper">
    ...
    <div class="mainBody">
            ...
            <div class="middle-red-block">
                <div class="title">
                    <div class="left"></div>
                    <div class="middle"><div class="text"><!-- InstanceBeginEditable name="BlockTitle" -->Активација на корисничка сметка<!-- InstanceEndEditable --></div></div>
                    <div class="right"></div>
                </div>
                 <div class="sodrzina" style="margin-top:-3px"><!-- InstanceBeginEditable name="BlockContent" -->
                   <div style="padding:5px;"><?php include("util/activate.php"); ?></div>
