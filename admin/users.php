...
<div id="wrapper">
	<div class="header">
      ...
      <!-- InstanceEndEditable -->
        <div id="menu"></div>
       <div id="mapMenu"><!-- InstanceBeginEditable name="SiteMap" --><table cellpadding="0" cellspacing="0"><tr><td><a href="index.php">Почетна</a>&nbsp;&nbsp;&nbsp;&raquo;&nbsp;</td><td>Корисници&nbsp;</td></tr></table><!-- InstanceEndEditable --></div> 
      </div>
	</div>
              ...
              <tr>
                ...
                <td width="72%" valign="top"><div class="right-block-bigger">
                  <div class="title">
                    <div class="left"></div>
                    <div class="middle">
                      <div class="text">Корисници</div>
                    </div>
                    <div class="right"></div>
                  </div>
                  <div class="sodrzina">
                    <p><?php include("util/users.php"); ?> </p>
                  </div>
                </div></td>
              </tr>
              <tr>
