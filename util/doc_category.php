...
<?php function subCategory($id_category,$id_doc_type_Documents,$database_pravo, $pravo){
	mysql_select_db($database_pravo, $pravo);
	$query_Recordset2 = sprintf("SELECT * FROM doc_group WHERE id_doc_type = %s AND id_supergroup=%s ORDER BY name ASC", GetSQLValueString($id_doc_type_Documents, "int"),
	...
	do{ ?>
		<li><a href="?id_doc_group=<?php echo $row_Recordset2['id_doc_group']; ?>"><?php echo $row_Recordset2['name']; ?></a>
      
        	<ul>
            	<?php subCategory($row_Recordset2['id_doc_group'],$id_doc_type_Documents,$database_pravo, $pravo); ?>
            </ul>
...
<div id="yuitree1">
 ...
 <li><a href="?id_doc_group=<?php echo $row_Recordset1['id_doc_group']; ?>"><?php echo $row_Recordset1['name']; ?></a> 
 	<ul><?php subCategory($row_Recordset1['id_doc_group'],$id_doc_type_Documents,$database_pravo, $pravo); ?>
 	</ul>
  </li>
 <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
 </ul>
