...
$query_latestLawsRecordset = "SELECT id_document, id_doc_group, id_doc_type, id_superdoc, title, published_date FROM `document` WHERE `document`.id_doc_type = 1 and `document`.show_on_home = 1 ORDER BY `document`.uploaded_date desc";
